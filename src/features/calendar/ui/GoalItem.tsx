...
export function GoalItem({
  ...
  const createAppeals = () => {
    router.push(
      `/appeals?goalId=${goal.id}&date=${date}`,
    );
  };
  ...
  return (
    <>
      <div className="space-y-4 rounded-xl border p-4 text-white shadow">
          ...
          <div className="relative w-full max-w-md rounded-2xl border border-gray-700 bg-[#0a1121] p-6 text-white shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                placeholder="Пароль"
                className="w-full rounded-xl border border-gray-700 bg-black/40 p-3 text-white outline-none focus:border-yellow-500"
              />
              ...
              <button
                ...
                className="w-full rounded-xl bg-yellow-600 p-3 font-medium transition hover:bg-yellow-700 disabled:opacity-50"
              >
                {unmark.isPending
                  ? 'Отмена...'
                  : 'Отменить выполнение'}
          ...
          <div className="relative w-full max-w-md rounded-2xl border border-gray-700 bg-[#0a1121] p-6 text-white shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                placeholder="Пароль"
                className="w-full rounded-xl border border-gray-700 bg-black/40 p-3 text-white outline-none focus:border-red-500"
              />
              ...
              <button
                ...
                className="w-full rounded-xl bg-red-600 p-3 font-medium transition hover:bg-red-700 disabled:opacity-50"
              >
                {deleteGoal.isPending
                  ? 'Удаление...'
                  : 'Удалить цель'}
